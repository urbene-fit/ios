...
//          if  let conversationVC = storyboard.instantiateViewController(withIdentifier: "SplashViewController") as? SplashViewController {
//
...
//        let sb = UIStoryboard(name: "Main", bundle: nil)
//        let otherVC = sb.instantiateViewController(withIdentifier: "UiTestController") as! UiTestController
//        let DuViewController = sb.instantiateViewController(withIdentifier: "DuViewController") as! DuViewController
//        DuViewController.selectedPolicy = userInfo
//
//       // policy = userInfo
////        Coffee.barista =  userInfo
////        print("메시지 수신후 체크:\(Coffee.barista)")
//
//        otherVC.pushAlram = true
//        if(otherVC.pushAlram){
//            print("알람수신 체크")
//        }
        
        
        //        self.window = UIWindow(frame: UIScreen.main.bounds)
        //                self.naviController = UINavigationController(rootViewController: DuViewController())
        //        self.naviController?.navigationBar.isHidden = true
        //                self.window?.rootViewController = self.naviController
        //                self.window?.makeKeyAndVisible()
       ...
       // print(userInfo)
        ...
        //                let sb = UIStoryboard(name: "Main", bundle: nil)
        //                let otherVC = sb.instantiateViewController(withIdentifier: "DuViewController") as! DuViewController
        //        otherVC.selectedPolicy = "저소득층 기저귀·조제분유 지원"
        //               //  window?.rootViewController = otherVC;
        //        self.naviController = UINavigationController(rootViewController: otherVC)
        //        self.naviController?.navigationBar.isHidden = true
        //                self.window?.rootViewController = self.naviController
       ...
       // let sb = UIStoryboard(name: "Main", bundle: nil)
//        if  let DuViewController = sb.instantiateViewController(withIdentifier: "DuViewController") as? DuViewController,
//            let tabBarVC = self.window?.rootViewController as? UITabBarController {
//
//
//            tabBarVC.selectedViewController?.present(DuViewController, animated: true, completion: nil)
...
//
        ...
        //사용자가 알림을 확인 한 시간을 체크하기 위해 푸쉬알림을 통해 앱에 들어올 시 서버에 알려준다.
        //이메일만 보냄
        
//        var userEmail = UserDefaults.standard.string(forKey: "email")
//        let parameters = ["email": userEmail!]
//
//        Alamofire.request("http://3.34.4.196/backend/php/common/benefit_fcm_recv.php", method: .post, parameters: parameters)
//            .validate()
//            .responseString()
//            //.responseJSON
//            { response in
...
//            }
        ...
        //        let sb = UIStoryboard(name: "Main", bundle: nil)
        //        let otherVC = sb.instantiateViewController(withIdentifier: "SecondViewController") as! SecondViewController
        //         // window?.rootViewController = otherVC;
        //sb.navigationController?.pushViewController(otherVC, animated: true)
