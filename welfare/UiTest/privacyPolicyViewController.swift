...
class privacyPolicyViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        firLabel.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 30 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 140 *  DeviceManager.sharedInstance.heightRatio)
        ...
        secLabel.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 180 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label3.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 220 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        let Label4 = UILabel()
        Label4.numberOfLines = 30
        Label4.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 250 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 420 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label5.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 690 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        let Label6 = UILabel()
        Label6.numberOfLines = 30
         Label6.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 730 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 100 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label7.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 850 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label8.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 890 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label9.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 930 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label10.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 990 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label11.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1030 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 80 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label12.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1130 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label13.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1170 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 60 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label14.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1250 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label15.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1290 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 60 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label16.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1370 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label17.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1410 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 80 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label18.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1510 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label19.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1550 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 300 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label20.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1870 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label21.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1930 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label23.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 1970 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label24.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2010 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 120 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label25.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2150 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label26.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2190 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label27.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2250 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label28.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2290 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 80 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label29.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2370 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label30.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2410 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 80 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label31.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2510 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label32.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2550 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label33.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2610 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label34.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2650 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label35.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2710 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label36.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2750 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 80 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label37.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2850 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        let Label38 = UILabel()
        Label38.numberOfLines = 10
        Label38.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 2890 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 160 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label39.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3070 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        let Label40 = UILabel()
        Label40.numberOfLines = 10
        Label40.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3110 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 180 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label41.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3310 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label42.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3350 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 60 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label43.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3430 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label44.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3470 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label45.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3530 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label46.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3570 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label47.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3630 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
        ...
        let Label48 = UILabel()
        Label48.numberOfLines = 15
        Label48.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3670 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 300 *  DeviceManager.sharedInstance.heightRatio)
      Label48.font = UIFont(name: "NanumBarunGothicBold", size:16 *  DeviceManager.sharedInstance.heightRatio)
        ...
        Label49.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3990 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
...
//
//        let Label50 = UILabel()
//        Label50.numberOfLines = 15
//        Label50.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3530 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 300 *  DeviceManager.sharedInstance.heightRatio)
...
//
//        let Label51 = UILabel()
//        Label51.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3850 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
//
...
//
//        let Label52 = UILabel()
//        Label52.numberOfLines = 3
//
//        Label52.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3890 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 40 *  DeviceManager.sharedInstance.heightRatio)
...
//
//        let Label53 = UILabel()
//        Label53.numberOfLines = 15
//        Label53.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 3950 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 300 *  DeviceManager.sharedInstance.heightRatio)
...
//
//        Label54.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 4270 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
//
...
//
//        Label55.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 4310 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 20 *  DeviceManager.sharedInstance.heightRatio)
//
...
//
//        let Label56 = UILabel()
//        Label56.numberOfLines = 15
//        Label56.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: 4350 *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 100 *  DeviceManager.sharedInstance.heightRatio)
...
//        for i in 0..<privacyTitle.count {
//            let titleLabel = UILabel()
//            titleLabel.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: CGFloat(280  * i)  * DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 30 *  DeviceManager.sharedInstance.heightRatio)
//
//            titleLabel.text = privacyTitle[i]
//            titleLabel.font = UIFont(name: "Jalnan", size:16 *  DeviceManager.sharedInstance.heightRatio)
//            m_Scrollview.addSubview(titleLabel)
//
//
//            var subtitleSplit = subTitle[i]
//            if(subtitleSplit != " "){
//                var arr =  subtitleSplit.components(separatedBy: "/")
//                for k in 0..<arr.count {
//                    let subTitleLabel = UILabel()
//
//                    subTitleLabel.frame = CGRect(x: 20 *  DeviceManager.sharedInstance.widthRatio, y: CGFloat((300  * i) + 200 * k) *  DeviceManager.sharedInstance.heightRatio, width: DeviceManager.sharedInstance.width - 20, height: 30 *  DeviceManager.sharedInstance.heightRatio)
//
//                    subTitleLabel.text = arr[k]
//                    subTitleLabel.font = UIFont(name: "Jalnan", size:12 *  DeviceManager.sharedInstance.heightRatio)
//                    m_Scrollview.addSubview(subTitleLabel)
//
//
//
//                }
...
//        }
        ...
        m_Scrollview.contentSize = CGSize(width:DeviceManager.sharedInstance.width, height: 4500 * DeviceManager.sharedInstance.heightRatio)
