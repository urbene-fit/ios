...
class ReViewViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate & UINavigationControllerDelegate , UITextViewDelegate{
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("ReViewViewController의 view가 Load됨")
        //메인 네비 타이틀 초기화
        // self.title = "메인"
    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        print("ReViewViewController의 view가 화면에 나타남")
        setBarButton()
        ...
        //        statusBar1.backgroundColor =  #colorLiteral(red: 0.9372549057, green: 0.1913873077, blue: 0.2772851493, alpha: 1)
        //        UIApplication.shared.keyWindow?.addSubview(statusBar1)
    }
    
    override func viewWillDisappear(_ animated: Bool) {
        super.viewWillDisappear(animated)
        print("ReViewViewController의 view가 사라지기 전")
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        print("ReViewViewController의 view가 사라짐")
    }
    
    override func viewWillLayoutSubviews() {
        super.viewWillLayoutSubviews()
        print("ReViewViewController의 SubView를 레이아웃 하려함")
    ...
    override func viewDidLayoutSubviews() {
        ...
        print("ReViewViewController의 SubView를 레이아웃 함")
    }
    ...
    //            var topView = UIView()
    //
    //            topView.frame = CGRect(x:0, y: 120, width: screenWidth, height: 90)
    //
    //            //취소버튼
    ...
    //            //self.navigationController?.navigationBar.topItem?.titleView = mainLabel
    //            //self.title = "혜택리뷰 수정"
    //
    //
    ////            let navItem = UINavigationItem(title: "등록하기")
    ////            let doneItem = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.done, target: nil, action: #selector(move))
    ...
    override func viewDidLoad() {
        ...
        //수정일 경우
            ...
            //작성하기 버튼
            enterBtn.frame = CGRect(x: screenWidth - 80, y: 20, width: 70, height: 70)
            enterBtn.setTitle("수정하기", for: .normal)
            enterBtn.titleLabel!.font = UIFont(name: "Jalnan", size:14.7)
            enterBtn.setTitleColor(UIColor.blue, for: .normal)
            enterBtn.tag = 2
            //        enterBtn.layer.cornerRadius = 4.3
            ...
            //텍스트뷰 플레이스 홀더
            contentView.delegate = self // txtvReview가 유저가 선언한 outlet
            contentView.text = modifyContent
            // contentView.textColor = UIColor.lightGray
    ...
    @objc func move(_ sender: UIButton) {
        ...
        if(sender.tag == 1){
            ...
            let parameterDict = NSMutableDictionary()
            parameterDict.setValue("eyJhbGciOiJzaGEyNTYiLCJ0eXAiOiJKd3QifS57InVzZXJuYW1lIjoiZW1haWwiLCJ0b2tlbl9tYWtlIjoiMjAyMC0xMi0wNiAxNToxMDoyMSJ9Ljk5N2VhNGE5YzMxMTc4NTdjMjZlZWNmNmE3ODg4NDExZGYyM2EwZGI3MWU4NzM3Mjg2ZGNkNDU0OWFkM2ZmZTA=", forKey: "login_token")
            //print(review_id)
            parameterDict.setValue(2, forKey: "review_id")
            parameterDict.setValue(contentView.text!, forKey: "content")
            
            
            let imgData = captureImage.jpegData(compressionQuality: 0.2)
            
            let url = try! URLRequest(url: URL(string:"https://www.urbene-fit.com/review")!, method: .post, headers: nil)
            ...
            Alamofire.upload(
                multipartFormData: { multipartFormData in
                    ...
                    multipartFormData.append(imgData!, withName: "file", fileName: "13일", mimeType: "image/png")
                },
                with: url,
                encodingCompletion: { encodingResult in
                    switch encodingResult {
