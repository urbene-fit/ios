    ...
    override func viewDidLoad() {
        ...
        for i in 0..<interst.count {
            ...
            if(i%2==0){
                ...
                button.addTarget(self, action: #selector(self.selected), for: .touchUpInside)
               // button.frame = CGRect(x:213, y:Double(Int(100) * (i - 1)/2) + 120, width: 180, height: 31)
        ...
        //주석
//        let inquiryBtn = UIButton(type: .system)
//
//
//
//
...
//        //버튼위치도 키워드 숫자에 따라 변경
//        inquiryBtn.frame = CGRect(x: 22, y: (count/2 * 80) + 300, width: Int(368.5), height: 59)
//
//        inquiryBtn.titleLabel!.font = UIFont(name: "Jalnan", size:16.1)
//        inquiryBtn.setTitleColor(.black, for: .normal)
//        inquiryBtn.layer.cornerRadius = 3.3
//        inquiryBtn.layer.borderWidth = 1.3
//        inquiryBtn.layer.borderColor = UIColor.darkGray.cgColor
//        //선택결과 페이지로 이동하는 메소드
