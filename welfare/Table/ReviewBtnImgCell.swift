...
class ReviewBtnImgCell: UITableViewCell {

    static let identifier = "ReviewBtnImgCell"
    //화면 스크롤 크기
...
//
    let modifyBtn: UIButton = {
        ...
        modifyBtn.addTarget(self, action: #selector(modify), for: .touchUpInside)
    ...
    let deleteBtn: UIButton = {
        ...
        deleteBtn.addTarget(self, action: #selector(modify), for: .touchUpInside)
